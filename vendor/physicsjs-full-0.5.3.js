...
(function(root, factory) {
  ...
  ! function(n) {
    ...
    function l(n, e, o, a, u, i) {
      ...
      for (p = !u, u || (u = O.pop() || []), i || (i = O.pop() || []), f = u.length; f--;)
        if (u[f] == n) return i[f] == e;
      var v = 0,
        c = !0;
      if (u.push(n), i.push(e), s) {
        ...
        for (; v--;)
          if (s = f, p = e[v], a)
            for (; s-- && !(c = l(n[s], p, o, a, u, i)););
          else if (!(c = l(n[v], p, o, a, u, i))) break;
        return c
      }
    ...
    function f() {
      ...
      var o = [];
      if (mt.enumPrototypes && o.push('!(G&&n=="prototype")'), mt.enumErrorProps && o.push('!(F&&(n=="message"||n=="name"))'), e.j && e.f) r += "var C=-1,D=B[typeof t]&&v(t),u=D?D.length:0;while(++C<u){n=D[C];", o.length && (r += "if(" + o.join("&&") + "){"), r += e.g + ";", o.length && (r += "}"), r += "}";
      else if (r += "for(n in t){", e.j && o.push("m.call(t, n)"), o.length && (r += "if(" + o.join("&&") + "){"), r += e.g + ";", o.length && (r += "}"), r += "}", mt.nonEnumShadows) {
    ...
    function m(n, t, e) {
      var r, o, a, u, i, l, c, f = 0,
        s = !1,
        p = !0;
      if (!y(n)) throw new TypeError;
      if (t = pt(0, t) || 0, true === e) var g = !0,
      p = !1;
      else v(e) && (g = e.leading, s = "maxWait" in e && (pt(t, e.maxWait) || 0), p = "trailing" in e ? e.trailing : p);
      var h = function() {
        var e = t - (et() - u);
      ...
      return function() {
        if (r = arguments, u = et(), i = this, c = p && (l || !g), false === s) var e = g && !l;
        else {
          o || g || (f = u);
          var y = s - (u - f);
    ...
    var z = {
      ...
      nt = X.test(nt = Object.getPrototypeOf) && nt,
      tt = Q.hasOwnProperty,
      et = X.test(et = Date.now) && et || function() {
        return +new Date
      }, rt = H.push,
      ...
      it = function() {
        try {
          var n = {}, t = X.test(t = Object.defineProperty) && t,
            e = t(n, n, n) && t
        } catch (r) {}
        return e
      }(),
      lt = X.test(lt = at.bind) && lt,
      ct = X.test(ct = Object.create) && ct,
      ft = X.test(ft = Array.isArray) && ft,
      st = X.test(st = Object.keys) && st,
      pt = Math.max,
      gt = Math.min,
      yt = Math.random,
      vt = H.slice;
    ...
    ! function() {
      ...
      try {
        mt.nodeClass = !(at.call(document) == R && !({
          toString: 0
        } + ""))
      } catch (o) {
        mt.nodeClass = !0
    ...
    y(/x/) && (y = function(n) {
      ...
      var t = n.valueOf,
        e = typeof t == "function" && (e = nt(t)) && nt(e);
  ...
  var Decorator = Physics.util.decorator = function Decorator(type, baseProto) {
    ...
    var factory = function factory(name, parentName, decorator, cfg) {
      ...
      var instance, result, parent = proto,
        tmp;
  ...
  (function(window) {
    ...
    Vector.prototype.transformInv = function(t) {
      ...
      return this.set(
        this._[0] * cosA + this._[1] * sinA + x, -this._[0] * sinA + this._[1] * cosA + y
      );
    };
    ...
    Vector.prototype.rotateInv = function(t) {
      ...
      return this.set(
        (this._[0] - t.o._[0]) * t.cosA + (this._[1] - t.o._[1]) * t.sinA + t.o._[0], -(this._[0] - t.o._[0]) * t.sinA + (this._[1] - t.o._[1]) * t.cosA + t.o._[1]
      );
    };
  ...
  Physics.geometry('convex-polygon', function(parent) {
    ...
    return {
      ...
      getFarthestCorePoint: function(dir, result, margin) {
        ...
        var norm, scratch = Physics.scratchpad(),
          next = scratch.vector(),
          prev = scratch.vector(),
          verts = this.vertices,
          l = verts.length,
          mag, sign = this._area > 0,
          data = {};
  ...
  Physics.behavior('body-collision-detection', function(parent) {
    ...
    var checkGJK = function checkGJK(bodyA, bodyB) {
      ...
      var scratch = Physics.scratchpad(),
        d = scratch.vector(),
        tmp = scratch.vector(),
        overlap, result, support, collision = false,
        aabbA = bodyA.aabb(),
    ...
    return {
      ...
      collideBodies: function(bodyA, bodyB, normal, point, mtrans, contact) {
        ...
        var invMoiA = fixedA ? 0 : 1 / bodyA.moi,
          ...
          ,
          impulse, sign, max, inContact = false;
      ...
      respond: function(data) {
        ...
        var self = this,
          col, collisions = Physics.util.shuffle(data.collisions);
  ...
  Physics.behavior('newtonian', function(parent) {
    ...
    return {
      ...
      behave: function(data) {
        ...
        var bodies = data.bodies,
          body, other, strength = this.strength,
  ...
  Physics.behavior('sweep-prune', function(parent) {
    ...
    return {
      ...
      checkOverlaps: function() {
        ...
        var isX, hash, tr1, tr2, bound, list, len, i, j, c
      ...
      updateIntervals: function() {
        ...
        var tr, intr, scratch = Physics.scratchpad(),
          pos = scratch.vector(),
          aabb = scratch.vector(),
          list = this.tracked,
          i = list.length;
      ...
      untrackBody: function(data) {
        ...
        var body = data.body,
          list, minmax, trackedList = this.tracked,
          tracker, count;
    ...
    return {
      ...
      resolveAngleConstraints: function(coef) {
        ...
        var constraints = this._angleConstraints,
          scratch = Physics.scratchpad(),
          trans = scratch.transform(),
          con, ang, corr, proportion, invMassSum;
  ...
  Physics.renderer('dom', function(proto) {
    ...
    // utility methods
    var thePrefix = {}, tmpdiv = document.createElement("div"),
